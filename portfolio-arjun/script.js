document.addEventListener('DOMContentLoaded', () => {
  ...
  if (contactForm) {
    contactForm.addEventListener('submit', (e) => {
      ...
      submitBtn.innerHTML = `
        <svg class="animate-spin" viewBox="0 0 24 24" style="animation: spin 1s linear infinite; width:16px; height:16px; fill:currentColor;">
      ...
      // Inject standard spinner animation keyframes dynamically to avoid bloating CSS if not needed elsewhere
  ...
  const projectDetails = {
    readease: {
      badge: "Idukki District Collectorate",
      title: "ReadEase",
      tagline: "Automatic Rain Gauge Meter Reading System",
      bullets: [
        "Designed an automated rain gauge system to provide accurate, real-time rainfall measurements for disaster management and planning.",
        "Used an ESP32 microcontroller to process ultrasonic sensor readings and convert them into rainfall values in millimeters.",
        "Enabled continuous, low-maintenance monitoring with minimal human intervention, reducing manual errors.",
    ...
    sportshub: {
      ...
      title: "Sports Hub",
      tagline: "College Sports Management Web Application",
      bullets: [
        "Developed a centralized web application to manage college sports activities including event creation and player registrations.",
        "Implemented core modules such as user registration and administrative panels using React.js and Node.js.",
        "Designed optimized MongoDB collections to store player, event, and attendance data for efficient retrieval."
      ],
      tags: ["React.js", "Node.js", "Express.js", "MongoDB"],
      github: "https://github.com",
      live: "https://sportshub.dev"
    },
    hexinox: {
      badge: "Hexinox",
      title: "Hexinox MERN Modules",
      tagline: "Internship Contributions",
      bullets: [
        "Contributed to web application modules using the MERN stack (MongoDB, Express.js, React.js, Node.js).",
        "Implemented user interface components, basic API integrations, and CRUD functionalities under mentor guidance.",
        "Used Git and GitHub for version control and collaborated in a team development environment."
      ],
      tags: ["MongoDB", "Express.js", "React.js", "Node.js"],
      github: "https://github.com",
      live: "https://hexinox.dev"
    }
  };
